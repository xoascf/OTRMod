...
public sealed class BitStream : IDisposable {
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="BitStream" /> class for the specified stream, and optionally leaves
	/// the stream open.
	/// </summary>
	/// <param name="sourceStream">The stream to be read.</param>
	/// <param name="leaveOpen">
	/// <see langword="true" /> to leave the <paramref name="sourceStream" /> open after the
	/// <see cref="BitStream" /> object is disposed; otherwise, <see langword="false" />.
	/// </param>

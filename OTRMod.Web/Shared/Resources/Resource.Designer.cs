...
namespace OTRMod.Web.Shared.Resources {
	...
	public static string txt_editor => GetLocalisedString("txt_editor");

	public static string txt_editor_desc => GetLocalisedString("txt_editor_desc");

	public static string txt_editor_h3 => GetLocalisedString("txt_editor_h3");

	public static string txt_editor_tab => GetLocalisedString("txt_editor_tab");

	public static string txt_editor_title => GetLocalisedString("txt_editor_title");
